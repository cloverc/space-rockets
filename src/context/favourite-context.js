...
const favouritesReducer = (
  state = { favouriteLaunches: [], favouriteLaunchPads: [] },
  action
) => {
  ...
  if (action.type === REMOVE_FAVE_LAUNCH) {
    ...
    return {
      favouriteLaunches: [...filteredLaunches],
  ...
  if (action.type === REMOVE_FAVE_LAUNCH_PAD) {
    ...
    return {
      ...
      favouriteLaunchPads: [...filteredLaunchPads],
    };
  }
  return state;
};
  ...
  return (
    <FavouritesContext.Provider
      value={{
        ...
        favouriteLaunchPads: state.favouriteLaunchPads,
        addLaunchToFaves,
        removeLaunchFromFaves,
        addLaunchPadToFaves,
        removeLaunchPadFromFaves,
      }}
    >
      {children}
    </FavouritesContext.Provider>
